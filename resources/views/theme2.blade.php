...
<header class="logo-container-detail-header-container">
    <div class="logo-container detail-header">
        <h1>RadiantNova</h1>
    </div>
    <nav class="logo-container-navbar">
        <ul>
    ...
    <div class="logo-container-navbar-svg">
        ...
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M14 3.50002H2.91L2.5 1.40002C2.47662 1.28538 2.41379 1.18257 2.32243 1.10948C2.23107 1.03639 2.11697 0.997659 2 1.00002H0V2.00002H1.59L3.5 11.6C3.52338 11.7147 3.58621 11.8175 3.67757 11.8906C3.76893 11.9636 3.88303 12.0024 4 12H13V11H4.41L4 9.00002H13C13.1156 9.00284 13.2286 8.96553 13.3197 8.89442C13.4109 8.82331 13.4746 8.72281 13.5 8.61002L14.5 4.11002C14.5168 4.03583 14.5164 3.9588 14.4989 3.88478C14.4814 3.81077 14.4472 3.74172 14.399 3.6829C14.3508 3.62408 14.2898 3.57703 14.2206 3.54534C14.1515 3.51365 14.076 3.49815 14 3.50002ZM12.6 8.00002H3.81L3.11 4.50002H13.375L12.6 8.00002Z" fill="#2A254B" />
        </svg>
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="16" height="16" fill="white" style="mix-blend-mode:multiply" />
